  ...
  return (
    ...
    >
      <Flex
        ...
        url('https://source.unsplash.com/1600x900/?nature,photography,technology')"
      ></Flex>
      <Flex justify="center">
      ...
      >
        <Flex align="center" justify="center" gap={2}>
          ...
          <Icon as={IoShareSocialOutline} fontSize="18pt" color="#fed716" />
      ...
      <Button
        ...
        height="30px"
        // bg="brand.100"
        bgGradient="linear(to-r, yellow.400, yellow.500, yellow.500)"
        _hover={{
